...
copiedArr.push(newobject)
return copiedArr

}
console.log(`Task 6`, artists, 'John Doe', '1988-2022', 'Full Stack Development', 'African American', 'I have a background in customer service at Big Retail Chain. I am attending BloomTech to become a Frontend Developer.')
...
function lotsOfArt(arr) {
 ...
 for(let i = 0; i < arr.length; i++)
  if(arr[i].paintings > 100){
    paintingsArray.push(arr[i]["name"])
...
console.log(`Task 8`,artistInfo(artists, 'Gustav Klimt'))
...
function artistByCountry(arr, place){
  let artistsNationalities = []
  for(let i = 0; i < arr.length; i++){
    if(place === arr[i].nationality)
    artistsNationalities.push(arr[i].name)
  }
return artistsNationalities  
}
